...
const conxoRoot = environment.conxoRoot;
...
const data: IMenuItem[] = [
  ...
  },
  {
    ...
    subs: [
      {
        label: 'menu.th-datainfo-basic-0',
        to: `${adminRoot}/datainfo`,
        // roles: [UserRole.Editor],
      },
      {
        label: 'menu.th-datainfo-pos-0',
        to: `${adminRoot}/datainfo`,
        subs: [
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.th-datainfo-pos-1',
            to: `${adminRoot}/datainfo`,
          },
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.th-datainfo-pos-2',
            to: `${adminRoot}/datainfo`,
          },
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.th-datainfo-pos-3',
            to: `${adminRoot}/datainfo`,
          },
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.th-datainfo-pos-4',
            to: `${adminRoot}/datainfo`,
          },
          {
            icon: 'simple-icon-arrow-right',
          ...
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.th-datainfo-pos-6',
            to: `${adminRoot}/datainfo/bestseller`,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        subs: [
          ...
          },
          {
            icon: 'simple-icon-arrow-right',
            label: 'menu.third-level-1',
            to: `${adminRoot}/menu/levels/third-level-11`,
          },
        ],
      },
      {
